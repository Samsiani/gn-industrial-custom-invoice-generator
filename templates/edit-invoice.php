    ...
    <table id="invoice-table">
      ...
      <tbody id="invoice-items">
        ...
        <tr class="cig-item-row" data-row="<?php echo esc_attr($row_id); ?>" data-original-price="<?php echo esc_attr($item['original_price'] ?? $item['price']); ?>">
          ...
          <td class="col-price"><input type="number" class="price" value="<?php echo esc_attr($item['price']); ?>" step="1"><span class="sale-percent-wrap no-print"><input type="number" class="sale-percent" min="0" max="100" step="0.01" placeholder="<?php esc_attr_e('Sale %', 'cig'); ?>"></span><span class="cig-original-price" style="display:none;"></span></td>
          <td class="col-total"><input type="number" class="row-total" value="<?php echo esc_attr($item['total']); ?>" step="0.01"><span class="cig-original-total" style="display:none;"></span></td>
        ...
        <tr class="cig-item-row" data-row="1" data-original-price="0">
            ...
            <td class="col-price"><input type="number" class="price" value="0" step="1"><span class="sale-percent-wrap no-print"><input type="number" class="sale-percent" min="0" max="100" step="0.01" placeholder="<?php esc_attr_e('Sale %', 'cig'); ?>"></span><span class="cig-original-price" style="display:none;"></span></td>
