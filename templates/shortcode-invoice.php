...
$bank3_logo    = isset($settings['bank3_logo']) ? $settings['bank3_logo'] : '';
$bank3_name    = isset($settings['bank3_name']) ? $settings['bank3_name'] : '';
$bank3_account = isset($settings['bank3_account']) ? $settings['bank3_account'] : '';
